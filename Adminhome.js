...
xhr.onload = function() {
 ...
 //   var container = document.querySelector('.receipecontainer');
    ...
    if (recipes === "No Pending Receipe found.")
    {

        // Display a message indicating that no rejected recipes were found
        var message = document.createElement('p');
        message.textContent = recipes;
    ...
    function showPage(page) {
      ...
      var endIndex = Math.min(startIndex + recipesPerPage, recipes.length);
       ...
       // Add a header row to the table
            ...
            var receipeownerHeader = document.createElement('th');
            ...
            receipeownerHeader.textContent = 'Created By';

            statusheader.textContent = 'Status';
            editHeader.textContent = 'Action';

            headerRow.appendChild(numberHeader);
            headerRow.appendChild(nameHeader);
            headerRow.appendChild(dateHeader);
            headerRow.appendChild(receipeownerHeader);
      ...
      for (var i = startIndex; i < endIndex; i++) {
        ...
        var receipeownerCell = document.createElement('td');
        ...
        receipeownerCell.textContent = recipe.Createdby;    
        ...
        row.appendChild(receipeownerCell);
...
xhr.onload = function() {
 ...
 //   var container = document.querySelector('.receipecontainer');
    ...
    if (recipes === "No Rejected Receipe found.")
    {
...
xhr.onload = function() {
 ...
 //   var container = document.querySelector('.receipecontainer');
    ...
    if (recipes === "No Active Receipe found.")
    {
