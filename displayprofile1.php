...
<?php
   ...
   $sql_profile_Query = "select ui.User_Id, ui.SecurityQuestion,ui.Answer,concat(ui.FirstName,' ',ui.LastName) as fullname, ui.City, ui.ZipCode, ui.Mobile,ui.Email,ui.CreatedDate,ua.Subscription_Type
